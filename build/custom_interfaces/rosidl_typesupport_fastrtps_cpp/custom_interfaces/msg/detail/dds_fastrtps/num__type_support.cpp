...
#include "custom_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::Num & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::Num *>(
    untyped_ros_message);
...
get_message_type_support_handle<custom_interfaces::msg::Num>()
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, Num)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
